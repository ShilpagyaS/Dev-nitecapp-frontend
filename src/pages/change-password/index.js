...
function ChangePassword() {
    ...
    const [conditions, setconditions] = useState(
        [
            ...
            { id: "2", message: "Contains both uppercase and lowercase letters.", response: _INITIAL },
            { id: "3", message: "Contains both letters and numbers.", response: _INITIAL },
            { id: "4", message: "Contains atleast onw special character , e.g, ! @ # ? ]", response: _INITIAL },
    ...
    function validatePassword() {
        ...
        setErrors({
            ...
            number,
            special,
            match: (password.newPassword == password.confirmPassword && password.newPassword != "")
        });
    ...
    function updateConditionStatus() {
        let dummy = conditions.map((cond) => {
            switch (cond.id) {
                ...
                case "3":
                    if (errors.number == true && (errors.uppercase == true || errors.lowercase == true))
                        return { ...cond, response: _PASS }
                    else return { ...cond, response: _ERROR }
                case "4":
                    if (errors.special == true)
                        return { ...cond, response: _PASS }
                    else return { ...cond, response: _ERROR }
                case "5":
        ...
        setconditions(() => [...dummy])
        if ((errors.passwordLength != true || errors.uppercase != true || errors.lowercase != true || errors.special != true || errors.number != true)) {
    ...
    function handleChange(e) {
        ...
        console.log((name == "newPassword" && (errors.passwordLength != true || errors.uppercase != true || errors.lowercase != true || errors.special != true || errors.number != true)))
    ...
    return (
        <>
            <LayoutWithHeader>
                ...
                <div className='mt-[40px] sm:mt-[50px] w-full flex flex-col items-center' >
