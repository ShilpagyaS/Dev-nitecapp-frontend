...
function LearnModuleContentAdmin() {
    const a = [1, 2, 3, 4, 5, 6, 7, 8, 9]
    const [counter, setCounter] = useState(0);
    return (
        <div className='w-full min-h-[500px] h-full bg-[#383838] rounded-t-[12px] mt-[20px] relative overflow-hidden'>
            <div className='w-full relative rounded-t-[12px] bg-transparent p-[15px] grid grid-cols-5 '>
                <div className='col-span-2 bg-transparent flex items-center'>
                    <RxCross1 size={25} color="#929292" className='bg-transparent' />
                </div>
                <div className='bg-transparent col-span-2 flex items-center'>
                    <p className='font-[700] not-italic font-Inter text-white text-[18px] bg-transparent'>Introduction to Beer</p>
                </div>
                <div className=' col-span-1 bg-transparent flex items-center justify-end'>
...
export default LearnModuleContentAdmin