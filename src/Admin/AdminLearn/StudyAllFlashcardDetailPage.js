...
import { emptycourses, getFlashCardsByType } from '@/store/slices/learnslice'
import Flashcarddetailcomponent from '@/utils/Cards/Learnsection/Flashcarddetailcomponent'
import Image from 'next/image'
import React, { useEffect, useState } from 'react'
import { useDispatch, useSelector } from 'react-redux'

function StudyAllFlashcardDetailPage({ type }) {
  ...
  useEffect(() => {
    ...
    dispatch(getFlashCardsByType(type))
...
export default StudyAllFlashcardDetailPage