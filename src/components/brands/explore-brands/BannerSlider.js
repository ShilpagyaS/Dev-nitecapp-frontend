    ...
    <>
      ...
      >
        {sliderData?.map((slide, i) => {
          return (
            <SwiperSlide key={i}>
              <div className="p-4 bg-[url('/asset/image.png')] h-full bg-no-repeat bg-center  brand-img-container">

                <div className="bg-transparent h-full flex items-center w-full justify-between">
                  <CustomButton
                    onClickHandler={prev}
                    label={leftArrowIcon}
                    hover={false}
