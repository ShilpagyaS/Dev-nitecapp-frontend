...
function FlashcardEndScreen() {
    return (
        <div className='h-full w-full'>
            ...
            '>Bar 101 Flashcard</span>, here is the result</p>
               ...
               flex flex-col items-center justify-center' >
                        ...
                        <p className='not-italic font-semibold text-[14px] bg-transparent text-white w-full text-left'> 100 / 100 cards</p>

                    </div>
                    <div className='h-[70px] w-[130px] border border-white bg-[#383838] rounded-[6px] p-[10px] 
               flex flex-col items-center justify-center' >
                        <p className='not-italic font-semibold text-[15px] bg-transparent text-white text-left w-full'> Learned</p>
                        <p className='not-italic font-semibold text-[14px] bg-transparent text-white w-full text-left'> 99 cards</p>

                    </div>
                    <div className='h-[70px] w-[130px] border border-white bg-[#383838] rounded-[6px] p-[10px] 
               flex flex-col items-center justify-center' >
                        <p className='not-italic font-semibold text-[15px] bg-transparent text-white text-left w-full'> Missed</p>
                        <p className='not-italic font-semibold text-[14px] bg-transparent text-white w-full text-left'> 1 cards</p>

                    </div>
                    <div className='h-[70px] w-[130px] border border-white bg-[#383838] rounded-[6px] p-[10px] 
               flex flex-col items-center justify-center' >
                        <p className='not-italic font-semibold text-[15px] bg-transparent text-white text-left w-full'> Percentage</p>
                        <p className='not-italic font-semibold text-[14px] bg-transparent text-white w-full text-left'> 95% </p>

                    </div>
                </div>
            </div>
            <div className=' w-full p-[20px] flex items-center justify-center mt-[13px]'>
                <Bigbutton text={'Go to Learn '} colorTrue={false} onClickHandle={() => { setStats('missed'); onNext(); setReset(true) }} />
                <div className='ml-[20px]'>

                    <Bigbutton2 text={'Take me to next Flashcards'} colorTrue={true} onClickHandle={() => { setStats('learned'); onNext(); setReset(true) }} />
                </div>
            </div>
