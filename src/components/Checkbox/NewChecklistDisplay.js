                    ...
                    <>  {
                        ...
                        <div className='rounded-[10px] flex justify-between w-full h-full my-[10px] px-[12px] bg-black cursor-pointer hover:-translate-y-[2px] duration-200 border border-[#363636] hover:border-white transition-all'
                            ...
                            <div className='flex bg-transparent'>
                                ...
                                {
                                    task?.checklist_sub_tasks?.length < 1 &&
                                    <div className='flex items-center ml-[15px]' onClick={(e) => { e.stopPropagation(); onflagged(i, true, task.checklist_task_id) }}>
                            ...
                            <div className='rounded-[10px] flex justify-between w-full h-full my-[10px] px-[12px] bg-[#191919] cursor-pointer duration-200 border border-white transition-all'
                                ...
                                <div className='flex bg-transparent'>
                                    ...
                                    <div className='flex items-center ml-[15px] bg-transparent'
                                        onClick={(e) => {
                                            e.stopPropagation();
                    ...
                    <>  {
                        ...
                        <div className='rounded-[10px] flex justify-between w-full h-full my-[10px] px-[12px] bg-black cursor-pointer hover:-translate-y-[2px] duration-200 border border-[#363636] hover:border-white transition-all'
                            ...
                            <div className='flex bg-transparent'>
                                ...
                                <div className='flex items-center ml-[15px]' onClick={(e) => { e.stopPropagation(); onflagged(i, true, task.checklist_sub_task_id, task.title) }}>
                                    <FlagIcon condition={task?.isFlag} />
                                </div>
                            </div>
                            ...
                            <div className='rounded-[10px] flex justify-between w-full h-full my-[10px] px-[12px] bg-[#191919] cursor-pointer duration-200 border border-white transition-all'
                                ...
                                <div className='flex bg-transparent'>
                                    ...
                                    <div className='flex items-center ml-[15px] bg-transparent' onClick={(e) => { e.stopPropagation(); onflagged(i, false, task.checklist_sub_task_id, task.title) }}>
                                        <FlagIcon condition={task?.isFlag} />
