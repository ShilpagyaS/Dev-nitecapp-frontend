...
export default function CoffeeFileUpdate({ setimage, defaultImage, isClear, isEdit, id }) {
    ...
    return (
        <div className="w-full h-full">
            {image.preview ? (<>
                <div className={`img-container relative w-full min-w-[186px] h-full ${isMobile ? "block m-auto" : "mr-[31px] "
                    }`}>
                    {/* <Image src="/asset/coctail1.png" className="w-full" fill /> */}

                    <Image src={image.preview} className="w-full object-cover" fill priority />
