...
export default function BrandFileUpload({ setimage, defaultImage, isClear, isEdit }) {
            ...
            {image.preview ? (<>
                <div className="relative"> 
                    ...
                    <label htmlFor="upload-button">
                        ...
                        {isEdit &&
                            <>
                                <div className="editbutton flex items-center justify-center bg-[#F19B6C] p-2 rounded-full w-fit absolute bottom-0 right-1 ">
                                    <svg width="18" height="18" viewBox="0 0 18 18" className="bg-[#F19B6C]" fill="none" xmlns="http://www.w3.org/2000/svg">
