...
function NewChapterAccordiam({ chapters, onEditChapter, onAddmodule, onaddContent, onEditmodule, onEditContent, videoPreviewClick, addquiz, pagePreviewClick }) {
                                                                    ...
                                                                    }
                                                                    {
                                                                        ...
                                                                        <>
                                                                            <div className=' flex items-center bg-transparent '>
                                                                                ...
                                                                                <div className='flex items-center cursor-pointer bg-transparent mr-[10px]' onClick={(e) => { pagePreviewClick(e) }}>
