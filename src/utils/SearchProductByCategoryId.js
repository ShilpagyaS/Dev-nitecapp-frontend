import { getProductSearch, getProductSearchByCategory } from '@/store/slices/product';
import Image from 'next/image';
import React, { useEffect, useState } from 'react'
import { useDispatch } from 'react-redux';

const SearchProductByCategoryId = ({
    placeholder,
    label,
    defaultvalue,
    type,
    ...
    useEffect(() => {
        ...
        const getData = setTimeout(async () => dispatch(getProductSearchByCategory(testvalue, type, productId)).then(res => {
            // console.log(res);
...
export default SearchProductByCategoryId