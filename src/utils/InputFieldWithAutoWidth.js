...
export function InputFieldWirhAutoWidthNomargin({
  placeholder,
  label,
  value,
  name,
  ...
  return (
    <div className=" flex flex-col gap-[4px] items-start">
      ...
      <input
        className={`box-border mt-[2px] py-[8px] pr-[13px] pl-[16px] rounded-[9px] h-[50px] min-w-[328px] sm:min-w-[302px] border border-solid border-[#3C3C3C] text-white font-Inter not-italic font-normal text-[14px]  placeholder-[#959595] placeholder:font-Inter placeholder:text-[14px] focus:outline-none ${errorResponnse == _INITIAL
          ? "focus:border-white  focus:ring-offset-white focus:ring-1 "
          : errorResponnse == _PASS
            ? "border-[#3FD79C] ring-1 ring-[#3FD79C]"
            : "border-[#EB4949] ring-1 ring-[#EB4949]"
