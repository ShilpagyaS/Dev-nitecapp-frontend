            ...
            <div className="relative ">
              ...
              focus:border-white  focus:ring-offset-white focus:ring-1 
                block w-full  appearance-none pr-[35px]`}
                    ...
                    onFocus={() => { setEnableOption(true); setisFocused(true) }}
                    onBlur={() => {
                        setTimeout(() => {
                ...
                />
                <div className={`cursor-pointer absolute top-2 right-2 flex items-center h-[40px]
                 ${isfocused == false
                    ? 'text-[#959595]'
                    : 'text-white'
                    ...
                    <svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="7.72656" cy="7.79956" r="6.75" stroke="#929292" strokeWidth="1.5" />
                        <rect x="13.8203" y="12.1089" width="6.83381" height="1.5" transform="rotate(40.6744 13.8203 12.1089)" fill="#929292" />
                    </svg>
