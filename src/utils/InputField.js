...
function InputField({
  ...
  return (
    <div className=" flex flex-col gap-[4px] items-start lg:mb-[11px] mb-[8px]">
      ...
      <input
        className={`box-border mt-[4px] py-[8px] pr-[13px] pl-[16px] rounded-[9px] h-[50px] min-w-[328px] max-w-[328px] sm:min-w-[302px] sm:max-w-[302px] border border-solid border-[#3C3C3C] text-white font-Inter not-italic font-normal text-[14px]  placeholder-[#959595] placeholder:font-Inter placeholder:text-[14px] focus:outline-none 
        ${!touched && !error
