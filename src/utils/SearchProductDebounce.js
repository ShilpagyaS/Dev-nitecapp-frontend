import { getProductSearch } from '@/store/slices/product';
...
const SearchProductDebounce = ({
    ...
    useEffect(() => {
        ...
        const getData = setTimeout(async () => dispatch(getProductSearch(testvalue, type)).then(res => {
            // console.log(res);
...
export default SearchProductDebounce